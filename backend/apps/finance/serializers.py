...
class ExpenseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ["id", "status", "submitted_by", "reviewed_by", "reviewed_at", "created_at", "updated_at"]
...
class InvoiceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Invoice
        fields = [
            "id", "invoice_number", "invoice_type", "vendor", "amount", "tax_amount",
        ...
        read_only_fields = ["id", "invoice_number", "status", "created_by", "approved_by", "created_at", "updated_at"]
...
class PayrollSerializer(serializers.ModelSerializer):
    ...
    department = serializers.CharField(source="employee.department_name", read_only=True, default="")
...
class PurchaseOrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "budget", "delivery_date", "justification", "status",
            "requested_by", "requested_by_name",
            "approved_by", "approved_by_name",
            "created_at", "updated_at",
        ]
        read_only_fields = ["id", "po_number", "status", "requested_by", "approved_by", "created_at", "updated_at"]
...
class StipendSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ["id", "status", "processed_by", "created_by", "created_at", "updated_at"]
