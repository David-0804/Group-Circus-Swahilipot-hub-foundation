...
class NotificationService:
    ...
    def send_fm_down_alert(cls, station, outage, reported_by):
        ...
        body = (
            ...
            f"Reported by: {reported_by.get_full_name()}\n"
        ...
        if phones:
            sms_body = f"Nexus ALERT: {station.name} FM DOWN at {outage.down_at.strftime('%H:%M')}. Reported by {reported_by.get_full_name()}."
