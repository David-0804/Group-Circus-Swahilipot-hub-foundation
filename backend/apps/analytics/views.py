...
class AnalyticsDashboardView(APIView):
    ...
    def _get_stats(self, org, today, now):
        ...
        try:
            ...
            stats.update({"wifi_active_grants": 0, "wifi_pending_grants": 0, "wifi_revoked_grants": 0})
        ...
        try:
            ...
            stats.update({"tickets_open": 0, "tickets_closed": 0, "tickets_total": 0, "ticket_resolution_rate": 0})
        ...
        try:
            ...
            stats.update({"certificates_issued": 0, "certificates_revoked": 0})
...
class SystemAnalyticsView(APIView):
    ...
    def get(self, request):
        ...
        avg_ms = 0
        try:
            sample = qs.filter(extra__has_key="duration_ms")[:500]
            durations = [
