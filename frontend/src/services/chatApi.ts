...
export const chatApi = {
  ...
  createGroup: (data: { name: string; description?: string; participant_ids: string[] }) =>
  ...
  sendMessage: (conversationId: string, data: { content: string; media_ids?: string[] }) =>
  ...
  // ── Calls ─────────────────────────────────────────────────────────────────
  initiateCall: (data: { recipient_id: string; type: "voice" | "video"; conversation_id: string }) =>
...
// ── WebSocket helper ──────────────────────────────────────────────────────────
// Real implementation would use a WS connection; this is the interface contract
