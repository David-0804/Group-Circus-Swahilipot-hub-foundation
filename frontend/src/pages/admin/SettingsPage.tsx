		...
		<div className="space-y-6 animate-fade-in">
			...
			<div className="flex gap-6">
				...
				<div className="flex-1 min-w-0">
					...
					{/* ── ORGANISATION (system_admin only) ── */}
						...
						<div className="space-y-5">
							<div className="card">
								...
								{orgLoading ? (
									...
									<OrgForm
										org={org}
										onSave={(d) => updateOrgMutation.mutate(d)}
					...
					{/* ── GEOFENCING (system_admin + hr_officer) ── */}
						...
						<div className="space-y-5">
							<div className="card">
								...
								<div className="alert alert-info mb-5">
									<MapPin size={14} />
									<span>
										Geofencing enforces that attachees must be within the set
										radius of the workplace to check in via GPS.
									</span>
								</div>
								<div className="space-y-5">
									<div className="input-group">
										...
										<div className="flex items-center gap-3">
											...
											<span className="text-slate-400 text-sm">
												metres from workplace centre
											</span>
										</div>
										<p className="text-xs text-slate-500 mt-1">
											Recommended: 100m for single-building, 200–500m for campus
										</p>
									</div>
									<div>
										<div className="text-xs text-slate-400 uppercase tracking-wide mb-3">
											Per-Branch GPS Coordinates
										</div>
										<div className="space-y-3">
											{branches.length === 0 ? (
												<p className="text-slate-500 text-sm">
													No branches to configure. Add branches first.
												</p>
											) : (
												branches.map((b: any) => (
													<div
														...
														<div className="grid grid-cols-3 gap-3">
															...
															<div className="input-group">
																...
																<input
																	type="number"
																	defaultValue={b.geofence_radius || 100}
																	className="input text-xs"
																/>
															</div>
														</div>
									...
									<div className="flex justify-end">
										<button
											...
											<Save size={14} /> Save Geofencing Config
										</button>
									</div>
								</div>
							</div>
					...
					{/* ── NOTIFICATIONS (system_admin + hr_officer) ── */}
							...
							<div className="card">
								...
								<div className="space-y-4">
									...
									<div className="input-group">
										...
										<input
											className="input"
											placeholder="NEXUS System <noreply@yourorg.com>"
										/>
									</div>
									<button
