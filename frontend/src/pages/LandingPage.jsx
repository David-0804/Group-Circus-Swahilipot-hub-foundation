...
const NEWS_ITEMS = [
	{
		...
		date: "2 Jun 2026",
		title:
			"Young Innovators Showcase Award-Winning Solutions at Swahilipot Hub",
		excerpt:
			"Youth innovators presented groundbreaking technology and community-driven solutions during the annual innovation showcase, attracting industry leaders, mentors, and investors from across the region.",
		readTime: "3 min",
		featured: true,
	},
	{
		...
		cat: "Technology",
		date: "28 May 2026",
		title: "New Digital Learning Lab Opens to Support Emerging Technologies",
		excerpt:
			"The newly launched innovation lab provides access to modern equipment, collaborative workspaces, and resources for software development, artificial intelligence, robotics, and digital creativity.",
		readTime: "4 min",
		featured: true,
	},
	{
		...
		cat: "Programs",
		date: "20 May 2026",
		title: "Applications Open for Digital Skills and Entrepreneurship Programs",
		excerpt:
			"Young people are invited to apply for upcoming training programs focused on software development, digital design, entrepreneurship, and innovation leadership.",
		readTime: "2 min",
		featured: false,
	},
	{
		...
		date: "15 May 2026",
		title:
			"Swahilipot Hub Partners with Industry Leaders to Expand Opportunities",
		excerpt:
			"New strategic partnerships will provide mentorship, internship opportunities, and career development pathways for youth participating in Swahilipot Hub programs.",
		readTime: "3 min",
		featured: false,
	},
	{
		...
		cat: "Events",
		date: "8 May 2026",
		title: "Community Innovation Day Scheduled for 14 June 2026",
		excerpt:
			"Students, innovators, entrepreneurs, and community members are invited to explore projects, attend workshops, and engage with technology demonstrations and networking sessions.",
		readTime: "2 min",
		featured: false,
	},
	{
		...
		date: "1 May 2026",
		title:
			"Digital Skills Initiative Reaches Hundreds of Youth Across the Coast Region",
		excerpt:
			"Swahilipot Hub continues to empower young people through hands-on training, mentorship, and innovation programs designed to build future-ready skills and create lasting community impact.",
		readTime: "5 min",
		featured: false,
	},
];
const FACILITIES = [
	{
		...
		desc: "A collaborative workspace equipped for web development, mobile applications, cloud computing, and software engineering projects led by young innovators.",
		icon: "💻",
		area: "Technology Wing",
	},
	{
		name: "Creative Design Studio",
		desc: "Modern digital design space for graphic design, UI/UX, branding, animation, and content creation using industry-standard tools.",
		icon: "🎨",
		area: "Creative Wing",
	},
	{
		name: "Innovation & Startup Hub",
		desc: "A dedicated space where entrepreneurs, innovators, and changemakers develop ideas, receive mentorship, and build sustainable ventures.",
		icon: "🚀",
		area: "Innovation Centre",
	},
	{
		name: "Digital Media Lab",
		desc: "Equipped for photography, videography, digital storytelling, content production, and multimedia communication projects.",
		icon: "📸",
		area: "Media Centre",
	},
	{
		name: "Emerging Technologies Lab",
		desc: "Hands-on learning environment focused on artificial intelligence, robotics, IoT, automation, and future technologies.",
		icon: "🤖",
		area: "Technology Wing",
	},
	{
		name: "Training & Learning Centre",
		desc: "Flexible training rooms used for workshops, coding bootcamps, digital skills programs, and professional development sessions.",
		icon: "📚",
		area: "Learning Block",
	},
	{
		name: "Community Collaboration Space",
		desc: "An open environment designed for networking, teamwork, hackathons, innovation challenges, and community engagement activities.",
		icon: "🤝",
		area: "Main Hub",
	},
	{
		name: "Events & Makers Space",
		desc: "A multifunctional venue for exhibitions, product showcases, entrepreneurship events, creative performances, and youth forums.",
		icon: "🎤",
...
const SUCCESS_STORIES = [
	...
	},
	{
		...
		title: "Joan's Coastal Ventures",
		quote:
			"My life's passion is offering unique travel experiences to local and international tourists who visit Mombasa — Swahilipot mentorship helped me turn that passion into a business.",
	},
	{
		name: "Nancy Moraa",
		role: "Communications, Swahilipot Hub",
		programme: "Mentorship Programme",
		title: "From Mentee to the Team",
		quote:
			"When you are given the opportunity to nurture your talent and grow yourself, do not relent. Continuous nurturing and mentorship gave me a strong base for my future.",
	},
];
...
const IMPACT_REPORTS = {
	2025: {
		youthReached: "36,000+",
		hubs: "55 youth hubs",
		mentors: "114 mentors & case managers",
		highlights: [
	...
	2024: {
		youthReached: "20,000+",
		hubs: "40 youth hubs",
		mentors: "90 mentors & case managers",
		highlights: [
	...
	2023: {
		youthReached: "8,000+",
		hubs: "20 youth hubs",
		mentors: "60 mentors & case managers",
		highlights: [
...
const WEEKLY_SCHEDULE = {
	...
	5: [
		// Friday — Request Hour replaces Kick Off
		{ time: "06:00", show: "The Breakfast Club", type: "live" },
	...
	getAudio() {
		if (!this.audio && typeof window !== "undefined") {
			...
			this.audio.addEventListener("pause", () =>
				this.emit({ onAir: false, elapsed: 0 }),
			);
...
const TEAM = [
	{
		name: "Mahmoud Noor",
		role: "Founder & Chief Mentor (Mentor 001)",
		dept: "Leadership",
	},
	...
	{
		name: "Nancy Moraa",
		role: "Communications & Corporate Affairs",
		dept: "Communications",
	},
];
...
async function generateImpactPdf(year) {
	...
	doc.text(
		"Empowering youth through technology, arts & entrepreneurship",
		M,
		122,
	);
	...
	doc.text(
		"Swahilipot Hub Foundation · Swahili Cultural Centre, Old Town, Mombasa · info@swahilipothub.co.ke",
		M,
		H - 50,
	);
	doc.text(
		`Generated ${new Date().toLocaleDateString("en-KE")} · swahilipothub.co.ke`,
		M,
		H - 36,
	);
...
function FMLiveWidget({ compact = false }) {
	...
	const showName = current
		? current.show
		: next
			? `Up Next: ${next.show} (${next.time})`
			: "Music & Replays";
	const showSub = current
		? `Live on Swahilipot FM`
		: next
			? "Station resumes shortly"
			: "Swahilipot FM";
		...
		<div
			...
			<div className="card-pad" style={{ padding: "24px 28px" }}>
				<div
					...
					{[0.5, 0.8, 1, 0.6, 0.9, 0.4, 0.7, 1, 0.5, 0.6, 0.8, 0.3].map(
						(h, i) => (
							<div
								key={i}
								className="audio-bar"
...
function HeroSection({ onNav }) {
	...
	const TICKERS = [
		"Swahilipot FM — Streaming Live Daily",
		"Community Open Days — Monday to Saturday, Free Entry",
		"36,000+ Youth Reached Across the Coast Region",
		"New Programs in Tech, Arts & Entrepreneurship — Apply Now",
		"Community Innovation Day — 14 June 2026",
	];
	useEffect(() => {
		const t = setInterval(() => setTick((x) => (x + 1) % TICKERS.length), 5000);
		return () => clearInterval(t);
	}, []);
		...
		<section
			...
			<div
				style={{
					position: "absolute",
					inset: 0,
					backgroundImage: `radial-gradient(ellipse at 60% 40%, rgba(201,151,58,0.07) 0%, transparent 65%), radial-gradient(ellipse at 10% 80%, rgba(29,185,84,0.04) 0%, transparent 50%)`,
					pointerEvents: "none",
				}}
			/>
			{/* Grid overlay */}
			...
			<div
				...
				<div>
					<div
						...
						<div
							...
							{[0.5, 1, 0.7, 0.9, 0.4].map((h, i) => (
								<div
									...
									className="audio-bar"
									style={{
										height: onAir ? `${h * 14}px` : "3px",
										animationDuration: `${0.5 + i * 0.15}s`,
										background: onAir ? T.green : "#666",
									}}
								/>
							))}
						</div>
						<span
							style={{
								color: onAir ? T.gold : "rgba(255,255,255,0.45)",
								fontSize: 11,
								fontWeight: 700,
								letterSpacing: "0.15em",
							}}>
							SWAHILIPOT FM · {onAir ? "ON AIR" : "OFF AIR"}
						</span>
					</div>
					...
					<p
						...
						Swahilipot Hub Foundation is a vibrant innovation and creative
						technology hub in Mombasa that empowers young people through digital
						skills training, entrepreneurship, innovation, arts, and
						community-driven programs, while providing a collaborative space
						where ideas are nurtured into impactful solutions that drive
						personal growth and positive community transformation.
					</p>
					<div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
						<button
							className="btn-primary"
							onClick={() => onNav("programs")}
							style={{ fontSize: 14, padding: "15px 32px" }}>
							Explore Programs
						</button>
						<button
							className="btn-outline-white"
							onClick={() => onNav("studios")}
							style={{ fontSize: 14, padding: "15px 32px" }}>
							Visit Our Spaces
						</button>
					</div>
						...
						{STATS.map((s) => (
							<div key={s.label}>
								<div
									...
									{s.unit && (
										<span
											style={{ color: T.gold, fontSize: 20, fontWeight: 700 }}>
											{s.unit}
										</span>
									)}
								</div>
				...
				<div>
					...
					<div
						...
						<div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
							{(WEEKLY_SCHEDULE[new Date().getDay()] || [])
								.slice(0, 5)
								.map((s, i, arr) => {
					...
					<FadeIn>
						<div>
							...
							<h2 className="section-title">
								...
								<br />
								<span className="italic" style={{ color: T.gold }}>
									Innovation & Creative
								</span>
								<br />
								Technology Hub
							...
							<p
								...
								Swahilipot Hub Foundation is a youth-focused innovation and
								creative technology hub based in Mombasa that empowers young
								people through digital skills training, technology,
								entrepreneurship, arts, and community-driven programs, creating
								a space where ideas are transformed into impactful real-world
								solutions.
							</p>
							<p
								style={{
								...
								We provide access to mentorship, collaborative workspaces, and
								capacity-building programs in software development, design,
								media, and innovation. Our community of innovators, creators,
								and entrepreneurs works on real projects that solve local
								challenges while connecting to global opportunities.
							</p>
							<div
								style={{
									display: "grid",
								...
								{[
									[
										"🚀",
										"Innovation Hub",
										"Youth-led technology and creative innovation space",
									],
									[
										"💻",
									...
									[
										"🎨",
										"Creative Economy",
										"Media, arts, and content creation empowerment",
									],
									[
										"🤝",
										"Community Impact",
										"Programs focused on solving real local challenges",
									],
								].map(([icon, title, sub]) => (
									<div
										key={title}
							...
							<div
								...
								<div
									...
									<div
										...
										Empowering Youth Through Technology, Creativity & Innovation
									</div>
								</div>
							</div>
							<div
								...
								{[
									["🚀", "100+ Programs", "Hackathons, training & incubations"],
									[
										"👩‍💻",
										"Community Members",
										"Developers, designers & creators",
									],
									["📍", "Mombasa", "Swahilipot Hub, Coast Region"],
									[
										"🌍",
										"Impact Driven",
										"Youth empowerment across East Africa",
									],
								].map(([icon, v, l]) => (
									<div
										key={v}
						...
						<div
							...
							{TEAM.map((m) => (
								<div
									...
									<span className="tag tag-navy" style={{ fontSize: 10 }}>
										{m.dept}
									</span>
								</div>
							))}
...
function ProgrammesSection() {
	...
	return (
		<section
			id="programmes"
			style={{ padding: "120px 5%", background: "#fff" }}>
			<div style={{ maxWidth: 1320, margin: "0 auto" }}>
				<FadeIn>
					<div style={{ marginBottom: 56 }}>
						...
						<p
							...
							Every programme is co-designed with media industry employers.
							Students work in live production environments from week one.
						</p>
					</div>
				</FadeIn>
				<div
						...
						<FadeIn key={p.code} delay={i * 0.06}>
							<div
								...
								<div
									style={{
										padding: "12px 20px",
										background: active === p.code ? T.gold : "transparent",
										textAlign: "center",
									}}>
									<span
										style={{
											fontSize: 12,
											fontWeight: 600,
											color: active === p.code ? T.navy : T.gold,
				...
				<FadeIn delay={0.1}>
					<div
						className="cta-grid card-pad"
						style={{ marginTop: 64, background: T.navy, padding: "52px 48px" }}>
						<div>
							<div
								style={{
									color: "rgba(255,255,255,0.5)",
							...
							<p
								...
								Book a free 30-minute session. We'll help you choose the right
...
function StudiosSection({ onNav }) {
	...
	return (
		<section
			id="studios"
			style={{ padding: "120px 5%", background: T.offWhite }}>
			<div style={{ maxWidth: 1320, margin: "0 auto" }}>
				<FadeIn>
					<div style={{ marginBottom: 56 }}>
						...
						{FACILITIES.map((f, i) => (
							<FadeIn key={f.name} delay={i * 0.05}>
								<div
									onClick={() => setActive(i)}
									style={{
										background: active === i ? T.navy : "#fff",
										border: `1px solid ${active === i ? "transparent" : T.border}`,
										padding: "20px 24px",
										marginBottom: 8,
										cursor: "pointer",
										transition: "all 0.2s",
									...
									<div
										style={{
											...
											flexShrink: 0,
											background:
												active === i ? "rgba(255,255,255,0.08)" : T.offWhite,
										}}>
										{f.icon}
									</div>
									<div style={{ flex: 1 }}>
										...
										<div
											style={{
												fontSize: 12,
												color:
													active === i ? "rgba(255,255,255,0.5)" : T.textLight,
											}}>
											{f.area}
										</div>
									</div>
							...
							<div
								...
								<div style={{ display: "flex", gap: 12 }}>
									...
									<button
										...
										onClick={() =>
											window.open(
												"https://www.swahilipothub.co.ke/events",
												"_blank",
											)
										}>
										View Activities
					...
					<div
						...
						<div>
							<div
								...
								Community Open Days: — Monday - Saturday
							</div>
							<div
								className="display"
								style={{
								...
								Explore Innovation Labs. Meet Creators. Experience Technology in
								Action.
							</div>
						</div>
						<button
							className="btn-navy"
							style={{ whiteSpace: "nowrap", padding: "15px 32px" }}
							onClick={() => onNav("programs")}>
							Register Free →
						</button>
					</div>
...
function NewsSection() {
	...
	const filtered =
		filter === "All" ? NEWS_ITEMS : NEWS_ITEMS.filter((n) => n.cat === filter);
							...
							{cats.map((c) => (
								<button
									...
									style={{
										...
										color: filter === c ? "#fff" : T.navy,
										border: `1.5px solid ${filter === c ? T.navy : T.border}`,
										padding: "7px 16px",
										fontSize: 12,
										fontWeight: 600,
										cursor: "pointer",
					...
					{rest.map((n, i) => (
						<FadeIn key={n.id} delay={i * 0.07}>
							<div
								...
								<div
									className="img-placeholder"
									style={{ height: 160, background: T.offWhite, fontSize: 36 }}>
									{n.cat === "FM Station"
										? "📡"
										: n.cat === "Admissions"
											? "📋"
								...
								<div style={{ padding: "20px 22px" }}>
									...
									<div
										...
										<span
											style={{ color: T.gold, fontSize: 12, fontWeight: 600 }}>
											Read More →
										</span>
									</div>
								</div>
						...
						<div>
							...
							<div
								...
								<p
									...
									Swahilipot FM is a youth-run community radio station based at
									the Swahilipot Hub in Old Town, Mombasa. Run by young
									presenters, producers and journalists from our programs, it
									amplifies youth voices, community stories and coastal culture
									— broadcasting daily on air and streaming online.
								</p>
								{[
									["Station", "Swahilipot FM"],
									["Base", "Swahilipot Hub, Old Town, Mombasa"],
									["Coverage", "Mombasa & the Coast region + online stream"],
									["Run by", "Youth presenters, producers & journalists"],
									["Listen", "On air & streaming via swahilipothub.co.ke"],
									["Format", "Youth Talk, Music, Community News, Culture"],
								].map(([k, v]) => (
									<div
										key={k}
										style={{
							...
							<div
								...
								{DAYS.map((d, i) => (
									<button
										...
										onClick={() => setDay(i)}
										style={{
											background: day === i ? T.gold : "rgba(255,255,255,0.06)",
											color: day === i ? T.navy : "rgba(255,255,255,0.5)",
											border:
												day === i ? "none" : "1px solid rgba(255,255,255,0.08)",
											padding: "7px 14px",
											fontSize: 12,
											fontWeight: 600,
											cursor: "pointer",
							...
							<div style={{ border: "1px solid rgba(255,255,255,0.08)" }}>
										...
										<div
											...
											<div>
												<div
													...
													<span
														style={{
															color: isNow ? "#fff" : "rgba(255,255,255,0.75)",
															fontSize: 14,
								...
								{(WEEKLY_SCHEDULE[day] || []).length === 0 && (
									<div
										...
										No scheduled shows — enjoy our music mix all day.
									</div>
								)}
							</div>
						</div>
					...
					<div
						...
						<div>
							...
							<p
								...
								{" "}
								Explore career, internship, and volunteer opportunities at
								Swahilipot Hub.
							</p>
						</div>
						<button
							...
							onClick={() =>
								window.open("https://www.swahilipothub.co.ke/careers", "_blank")
							}>
							Explore Careers
						</button>
					</div>
						...
						{STEPS.map((s, i) => (
							<div
								...
								<div
									style={{
										height: 4,
										background: s.n <= step ? T.gold : T.border,
								...
								<div
									style={{
										padding: "16px 20px",
										background: s.n === step ? "#fff" : "transparent",
										border:
											s.n === step
												? `1px solid ${T.border}`
									...
									<div
										style={{
											...
											letterSpacing: "0.08em",
											textTransform: "uppercase",
											color: s.n <= step ? T.navy : T.textLight,
											marginBottom: 4,
										}}>
										Step {s.n}
									</div>
				...
				<div className="two-col" style={{ alignItems: "start" }}>
					<FadeIn>
						<div>
							...
							<div
								...
								{[
									[
										...
										"KCSE Grade C- (minus) or equivalent qualification",
										"✅",
									],
									[
										"Age Requirement",
										"Applicants must be 17 years or older at time of enrolment",
										"✅",
									],
									[
										"Documents Required",
										"Original KCSE Certificate, National ID/Passport, 2 passport photos, birth certificate",
										"📋",
									],
									[
										"Application Fee",
										"KES 1,000 (non-refundable) — waived for early applicants before 31 July",
										"💳",
									],
									[
										"Scholarships",
										"Bursaries and partner-funded scholarships available for eligible youth",
										"🎓",
									],
									[
										"Medical Requirements",
										"Medical certificate confirming fitness for studio environments",
										"🏥",
									],
								].map(([label, val, icon]) => (
									<div
							...
							<div
								className="card-pad"
								style={{ background: T.navy, padding: "28px 36px" }}>
								<div
									className="display"
									style={{
										fontSize: 18,
								...
								{PROGRAMMES.slice(0, 4).map((p) => (
									<div
										...
										<span
											...
											{p.title.replace("Diploma in ", "")}
										</span>
										<span
											style={{ color: T.gold, fontSize: 13, fontWeight: 600 }}>
											{p.fee}
										</span>
									</div>
								))}
								<p
									...
									Fees inclusive of studio time, equipment access, and industry
									visits. Payment in two or three instalments available. Bursary
									support processed directly for eligible participants.
								</p>
							</div>
						</div>
					</FadeIn>
							...
							{submitted ? (
								<div
									...
									<p
										...
										{form.programme}. Our admissions team will contact you at{" "}
										{form.email} within 3 working days.
									</p>
									<div
										style={{
											background: T.offWhite,
										...
										<div style={{ color: T.textMuted, fontSize: 13 }}>
											Keep this reference for your records. Next step: We will
											call you for a brief 15-minute admissions interview.
										</div>
									</div>
									<button
										className="btn-outline"
								...
								<>
									...
									<p
										...
										Takes under 5 minutes. Applications for September 2026 are
										open.
									</p>
									{[
									...
									<div style={{ marginBottom: 16 }}>
										<label
											...
											KCSE Grade or Highest Qualification
										</label>
										<input
											className="input-field"
											type="text"
											placeholder="e.g. C+ or Diploma in Communication"
											value={form.kcse}
											onChange={(e) => upd("kcse", e.target.value)}
										/>
									</div>
									<div style={{ marginBottom: 24 }}>
										<label
											...
											Why do you want to study here? (Optional)
										</label>
										<textarea
											className="input-field"
											rows={3}
									...
									<p
										...
										contact you within 3 working days.
									</p>
								</>
							)}
						</div>
...
function ImpactsSection() {
	...
	useEffect(() => {
		const t = setInterval(
			() => setActive((a) => (a + 1) % SUCCESS_STORIES.length),
			6000,
		);
		return () => clearInterval(t);
	}, []);
					...
					<div
						...
						<div>
							...
							<p
								...
								Our impact goes beyond numbers. Here are real stories of youths
							...
							<div
								...
								<div
									...
									<div>
										...
										<div
											style={{ color: "rgba(255,255,255,0.4)", fontSize: 13 }}>
											{SUCCESS_STORIES[active].role}
										</div>
										<div style={{ color: T.gold, fontSize: 11, marginTop: 3 }}>
											{SUCCESS_STORIES[active].programme}
										</div>
									</div>
								</div>
							</div>
						...
						<div
							...
							{SUCCESS_STORIES.filter((_, i) => i !== active).map((s, i) => (
								<FadeIn key={s.name} delay={i * 0.07}>
									<div
										onClick={() => setActive(SUCCESS_STORIES.indexOf(s))}
										className="card-hover"
										style={{
										...
										<span
											style={{ color: T.gold, fontSize: 11, flexShrink: 0 }}>
											{s.title} →
										</span>
									</div>
								</FadeIn>
						...
						<FadeIn delay={0.1}>
							<div
								...
								<p
									...
									Our annual impact reports showcase the measurable change we're
									making in communities across East Africa.
								</p>
								...
								<div
									...
									<div
										...
										<div
											...
											<span
												...
												{IMPACT_REPORTS[reportYear].youthReached}
											</span>
										</div>
										<div
											style={{
											...
											<span
												...
												{IMPACT_REPORTS[reportYear].hubs}
											</span>
										</div>
									</div>
									...
									<p
										...
										Reports are fetched from our archive when available, or
										compiled live from our impact data.
									</p>
								</div>
							</div>
						</FadeIn>
				...
				<FadeIn delay={0.1}>
					<div
						...
						<div
							...
							Our Youth Build Careers & Ventures With
						</div>
						<div
							style={{
								display: "flex",
	...
	const handleSend = async () => {
		...
		try {
			const res = await fetch(
				`https://formsubmit.co/ajax/${SWAHILIPOT_EMAIL}`,
				{
					method: "POST",
					headers: {
								...
								{[
									{
										icon: "📍",
										label: "Address",
										val: "Swahili Cultural Centre, Sir Mbarak Hinaway Rd",
										sub: "Old Town, Mombasa, Kenya",
									},
									{
										icon: "📞",
										label: "Phone",
									...
									},
									{
										icon: "✉",
										label: "Email",
										val: "info@swahilipothub.co.ke",
										sub: "We respond as soon as we can",
									},
									{
										icon: "📻",
										label: "Radio",
										val: "Swahilipot FM",
										sub: "Youth-run community radio · live & streaming",
									},
									{
										icon: "🌐",
										label: "Website",
										val: "www.swahilipothub.co.ke",
										sub: "Programs, events & opportunities",
									},
								].map((item) => (
									<div
										key={item.label}
									...
									<div
										...
										<div style={{ textAlign: "center", position: "relative" }}>
											...
											<div
												...
												Swahilipot Hub · Old Town, Mombasa
											</div>
											<button
												className="btn-outline-white"
												style={{
					...
					<FadeIn delay={0.15}>
						{sent ? (
							<div
								...
								className="fade-in-anim card-pad">
								...
								<p
									...
									{sentVia === "direct" ? (
										<>
											...
											<strong>{SWAHILIPOT_EMAIL}</strong>. We'll get back to you
											as soon as we can. For urgent matters call +254 11
											4635505.
										</>
									) : (
										<>
											We couldn't send automatically, so your email app has
											opened with your message addressed to{" "}
											<strong>{SWAHILIPOT_EMAIL}</strong> — just press send
											there to deliver it.
										</>
									)}
								</p>
							...
							<div
								...
								<p
									...
									Your message goes straight to {SWAHILIPOT_EMAIL}.
								</p>
								{[
									["Full Name *", "name", "text", "e.g. Amina Hassan"],
									["Email Address *", "email", "email", "your@email.com"],
								...
								<div
									...
									<div style={{ flex: 1, textAlign: "center" }}>
										...
										<div
											style={{ fontWeight: 700, fontSize: 14, color: T.navy }}>
											{SWAHILIPOT_EMAIL}
										</div>
									</div>
									...
									<div style={{ flex: 1, textAlign: "center" }}>
										...
										<div
											style={{ fontWeight: 700, fontSize: 15, color: T.navy }}>
											Mon–Sat
										</div>
									</div>
								</div>
			...
			links: [
				{
					...
					href: "https://www.swahilipothub.co.ke/careers",
				},
			...
			<div style={{ maxWidth: 1320, margin: "0 auto" }}>
				...
				<div
					...
					<div>
						...
						<div
							...
							Join our programs in technology, arts and entrepreneurship — open
							to youth across the Coast region.
						</div>
					</div>
					<button
						className="btn-navy"
				...
				<div className="footer-grid">
					<div>
						...
						<div
							...
							Old Town, Mombasa, Kenya · Est. 2016
						</div>
						<p
							style={{
								color: "rgba(255,255,255,0.35)",
							...
							A technology, creatives and heritage space empowering youth across
							Kenya's coastal region through digital skills, entrepreneurship,
							arts and community-driven innovation.
						</p>
				...
				<div
					...
					<div style={{ color: "rgba(255,255,255,0.2)", fontSize: 12 }}>
						© 2026 Swahilipot Hub Foundation. Registered Non-Profit
						Organization, Mombasa, Kenya. All Rights Reserved.
					</div>
					...
					<div
						...
						{[0.5, 1, 0.6].map((h, i) => (
							<div
								...
								className="audio-bar"
								style={{
									height: onAir ? `${h * 12}px` : "3px",
									animationDuration: `${0.5 + i * 0.2}s`,
									background: onAir ? "#fff" : "#777",
								}}
							/>
						))}
					</div>
	...
	return (
		<div
			...
			<p
				...
				We use cookies to improve your experience, personalise content, and
				analyse our traffic in accordance with the Kenya Data Protection Act
				2019.
				<a href="#" style={{ color: T.gold, marginLeft: 4 }}>
					Learn more
				</a>
			</p>
