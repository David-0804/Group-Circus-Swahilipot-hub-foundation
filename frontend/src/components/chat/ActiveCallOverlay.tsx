...
export function ActiveCallOverlay() {
	...
	return (
		<div className="fixed top-20 right-6 z-50 w-64 bg-surface-card border border-surface-border rounded-2xl shadow-elevated overflow-hidden animate-slide-up">
			{/* Header */}
